...
HD_PWD='/home/mayanksingh2298/IIT_Course/sem4/col216/Labs/Lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MainDataPath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MainDataPath.tcl
