    		...
    		when arith=>
    			if((IR(27 downto 26)="01" or (IR(27 downto 26)="00" and IR(25)='0' and IR(7)='1' and IR(4)='1' and IR(6 downto 5)/="00")) and IR(23)='1') then--offset addition
	    			...
	    			op <= "0010";
                        ...
                        op <= "0100";
--                elsif(IR(27 downto 25)="000" and IR(22)='0' and IR(23) = '1' and (IR(11 downto 7)="00001" and IR(4)/='1') ) then
--                    op <= "0100";
--                elsif(IR(27 downto 25)="000" and IR(22)='0' and IR(23) = '0' and (IR(11 downto 7)="00001" and IR(4)/='1') ) then
--                        op <= "0010";
	    		else --ALU operation
	    			op <= IR(24 downto 21);
	    		end if;
