...
HD_PWD='/home/mayanksingh2298/IIT_Course/sem4/col216/Labs/ArchitectureAssignments-LAB5DEMO/Lab4And5/Processor_4/Processor_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MainProcessor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MainProcessor.tcl -notrace
