...
HD_PWD='/home/mayanksingh2298/IIT_Course/sem4/col216/Labs/ArchitectureAssignments-LAB5DEMO/Lab4And5/Processor_4/Processor_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MainProcessor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MainProcessor.tcl
