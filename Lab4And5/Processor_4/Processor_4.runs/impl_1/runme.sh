...
HD_PWD='/media/atishya/New_Volume1/books_and_papers/Iit/2nd_year/2nd_sem/COl216/Labs/Lab4/Processor_4/Processor_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MemoryModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MemoryModule.tcl -notrace
